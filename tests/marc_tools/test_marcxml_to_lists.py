...
class TestExtractAll:
    ...
    all_keys_bib_1 = marcxml_to_lists.extract_keys_for_single_record(
        marcxml_bib_element_1
    )
    all_keys_bib_2 = marcxml_to_lists.extract_keys_for_single_record(
        marcxml_bib_element_2
    )
